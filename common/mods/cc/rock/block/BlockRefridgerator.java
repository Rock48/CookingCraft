...
public class BlockRefridgerator extends BlockContainerCC{
    private Random rand = new Random();

    public BlockRefridgerator(int id)
    {
    ...
    {
        return new TileEntityRefridgerator();
    ...
    {
        sides = iconRegister.registerIcon(Reference.MOD_ID.toLowerCase() + ":basicFridge_sides");
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
    {
        ...
        else
        {
                ...
                TileEntityRefridgerator tile = (TileEntityRefridgerator) world.getBlockTileEntity(x, y, z);

                if (tile != null){
                	
                    player.openGui(CookingCraft.instance, GuiIDs.ID_REFRIDGERATOR, world, x, y, z);
                }
